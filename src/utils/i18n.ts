...
const resources = {
    en: {
        translation: {
            ...
            is_ignored_branches:
                'The action has been terminated as the `ignore_branches` provided to the action matches the specified glob pattern.',
            ...
            view_unchanged_package_files: 'View Unchanged Files',
            ...
            package_added: '➕ Added',
            package_updated: '⬆️ Updated',
            package_downgrade: '⬇️ Downgraded',
    ...
    ko: {
        translation: {
            ...
            is_ignored_branches:
                '액션에 주입된 `ignore_branches`와 지정된 glob 패턴이 일치하여 해당 액션이 종료되었습니다.',
            ...
            after_size: '변경 후 크기',
            size_changed: '증감',
            view_unchanged_package_files: '변경되지 않은 파일 보기',
